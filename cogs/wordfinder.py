...
class WordFinder(commands.Cog):
    ...
    @commands.command(aliases=["wfstart"], help="Start a Word Finder game against another user", usage="&wordfinderstart <@other_player>")
...
async def setup(bot):
    await bot.add_cog(WordFinder(bot))
